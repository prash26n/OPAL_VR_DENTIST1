Shader "o3n/Skin FFS Variant" {
    ...
    SubShader {
        ...
        CGPROGRAM
        #pragma surface surf StandardSkin
		...
		half4 BRDF3_Unity_PBS__ (half3 diffColor, half3 specColor, half oneMinusReflectivity, half smoothness,
        ...
        void surf (Input IN, inout SurfaceOutputStandardSkin o) {
            ...
            o.Specularity = maskColor.r * _SpecPow;    
